  ...
  return (
    <div className="container mx-auto max-w-6xl p-6 bg-white rounded-2xl shadow-2xl border border-gray-200">
      ...
      <div className="flex flex-col lg:flex-row gap-10">
        {/* Pet Image Section */}
        <div className="lg:w-1/2 flex justify-center items-center bg-gray-50 rounded-3xl p-6 shadow-inner">
          <img
            src={pet.image}
            alt={pet.name}
            className="w-full h-auto max-h-[600px] object-cover rounded-2xl transition-transform duration-300 hover:scale-105"
            onError={(e) => {
              e.target.onerror = null;
              e.target.src = `https://placehold.co/600x500/e0e0e0/555555?text=No+Image`;
            }}
          />
        </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <button
                ...
                className="p-3 bg-blue-100 text-blue-600 rounded-full shadow-md hover:bg-blue-200 transition-colors duration-200"
